...
| `manual.html` | **Manual de uso de la app** — documenta CADA parámetro editable de las 4 pestañas (qué es / cómo se usa / a qué afecta), un **guion para la reunión de socios** (15 min), cómo leer los resultados (GO/NO-GO, break-even de caja, pozo, matriz), glosario y banderas de honestidad. Imprimible A4. Enlazado desde el top-bar de la app (📘 Manual) y la landing. **Las explicaciones coinciden con los íconos ℹ inline** de cada herramienta (`.ttip` con `data-t`). |
