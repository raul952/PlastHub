...
- **Site CONFIRMED (croquis):** Cooperativa Agraria Parque Porcino, Ventanilla (Callao). **Area 2 = 1,800 m² = 50 m (frente, sobre la rampa) × 36 m (fondo) × ~6 m height.** Hosts **Stage 1 (distribution, front) + Stage 2 (processing, back) + offices (2 floors ~70 m²)**; the ramp/dock (~600 m²) is the front strip of Area 2. (Lot total ~4,200 m² = Area 2 1,800 + Area 1 1,248 + Area 3 1,152, the latter two already rented to others.) LOI: **Phase 1 (M2–M6) = 600 m²** (with ramp access); **Phase 2 (M7+) = full 1,800 m²** ≈ ramp/dock 600 + office ~70 (2 floors) + the rest ~1,130 (storage/process/circulation). E1 tool has presets "PP · Fase 1 · 600" and "PP · Fase 2 · 1,800 ★" (default; gate=8 → loading band ≈600).
